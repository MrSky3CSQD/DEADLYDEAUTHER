...
# Name: Mr.Sky3
# Author: Mr.Sky3 (Cyber Squad QD, Thunderous Hackers PH)
# Github: github.com/SkAnonymous
# Instagram: thphskanon1521
# Give me the credits if you recode this tool. Don't be a SKID!
# Deauther is made with Atom by Mr.Sky3 - Cyber Squad QD - 2022
...
function chk_root () {
	if [[ "$(id -u)" -ne 0 ]]; then
		banner
		printf " ${BD}${WH}[${RD}!${WH}] ${RD}DEADLY DEAUTHER must be run as root ${YW}"
		exit 1
	fi
}
